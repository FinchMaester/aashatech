        ...
        <div class="card-body">
            <div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="year" class="form-control" placeholder="Established Year"
                        id="establishment" value="{{ $sitesetting->year }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input name="linked_link" class="form-control" placeholder="LinkedIn URL (https://)"
                        id="linked_link" value="{{ $sitesetting->linked_link }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input name="f_page" class="form-control" placeholder="Facebook Page(https://)" id="f_page"
                        value="{{ $sitesetting->f_page }}">
                </div>

                <div class="form-group">
                    <label for="slogan">Slogan</label>
                    <textarea type="text" name="slogan" class="form-control" height="300" width="500"
                        placeholder="Your slogan Here" id="slogan">{{ $sitesetting->slogan }}</textarea>

                </div>
                <div class="form-group">
                    <label for="slogan">Description</label>
                    <textarea type="text" name="desc" class="form-control" height="300" width="500"
                        placeholder="Company Description here" id="desc">{{ $sitesetting->desc }}</textarea>
