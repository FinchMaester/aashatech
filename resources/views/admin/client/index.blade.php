...
@section('content')
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            ...
            <a href="{{ url('admin/client/create') }}"><button class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>Add
                    Clients</button></a>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <tbody>
            @foreach ($clients as $client)
                <tr data-widget="expandable-table" aria-expanded="false">
                    ...
                    <td><img src="{{ asset($client->image) }}" style="width: 150px; height: 150px;">
                    </td>
