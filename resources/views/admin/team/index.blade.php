...
@section('content')
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            ...
            <a href="{{ url('admin/team/create') }}"><button class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>Add
                    Team</button></a>
        ...
        <tbody>
            @foreach ($teams as $team)
                <tr data-widget="expandable-table" aria-expanded="false">
                    ...
                    <td>
                        @if ($team->image)
                            <img src="{{ asset($team->image) }}" style="width: 150px; height: 150px;" alt="Team Image">
                        @else
                            <span>No Image</span>
                        @endif
                    </td>
