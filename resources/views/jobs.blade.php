...
@section('content')
    ...
    <main class="main mb-3">
        <div class="container">
            <h2 class="u-text u-text-custom-color-1 u-text-default u-text-1">Applying for:{{ $job->title }}</h2>
                    ...
                    <div class="card">
                        <div class="card__body">
                            ...
                            <form action="{{ route('job-applications.store') }}" method="POST"
                                ...
                                <button type="submit"
                                    class="u-active-custom-color-1 u-button-style u-hover-custom-color-1 u-nav-link u-text-active-white u-text-custom-color-1 u-text-hover-white active">Apply
                                    Now</button>
                            </form>
                        </div>
                    </div>
