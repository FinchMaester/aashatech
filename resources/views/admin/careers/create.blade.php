...
@section('content')
    ...
    <form id="quickForm" novalidate="novalidate" method="POST" action="{{ route('careers.store') }}"
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea style="width:auto;" name="description" class="form-control" id="description" placeholder="Description">{{ old('description') }}</textarea>
            </div>
