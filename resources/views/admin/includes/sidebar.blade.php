        ...
        <div class="navbar-vertical-content scrollbar">
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                    ...
                    {{-- Start Favicon --}}
                    <a class="nav-link" href="{{ route('Favicon.index') }}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                                ...
                                </svg></span><span class="nav-link-text ps-1">Favicon</span></div>
                    </a>
                    {{-- End Favicon --}}
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link dropdown-indicator" href="#email" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                                ...
                                </svg><!-- <span class="fas fa-envelope-open"></span> Font Awesome fontawesome.com --></span><span
                    ...
                    <ul class="nav collapse" id="email">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ route('Coverimage.index') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Cover
                                        Image</span></div>
                            </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('Backimage.index') }}">
                        ...
                        <li class="nav-item"><a class="nav-link" href="{{ route('About.index') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-1">About
                                        Us</span>
                                </div>
                            </a><!-- more inner pages-->
                    ...
                    <!-- parent pages--><a class="nav-link" href="{{ route('Welcome.index') }}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                                ...
                                </svg><!-- <span class="fas fa-calendar-alt"></span> Font Awesome fontawesome.com --></span><span
                                class="nav-link-text ps-1">Welcome Page</span></div>
                    </a><!-- parent pages--><a class="nav-link" href="{{ route('Category.index') }}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                                ...
                                </svg><!-- <span class="fas fa-comments"></span> Font Awesome fontawesome.com --></span><span
                    ...
                    <a class="nav-link" href="{{ route('Message.index') }}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                    ...
                    <a class="nav-link" href="{{ route('Services.index') }}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                    ...
                    <a class="nav-link" href="{{ route('Team.index') }}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                    ...
                    <a class="nav-link" href="{{ route('Advisor.index') }}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                                ...
                                class="nav-link-text ps-1">Advisor</span></div>
                    </a>
                    <a class="nav-link" href="{{ route('Legaldocs.index') }}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                    ...
                    <a class="nav-link" href="{{ route('Client.index') }}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                    ...
                    <a class="nav-link dropdown-indicator" href="#events" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                                ...
                                </svg><!-- <span class="fas fa-calendar-day"></span> Font Awesome fontawesome.com --></span><span
                                class="nav-link-text ps-1">Gallery</span></div>
                    </a>
                    <ul class="nav collapse" id="events">
                        <li class="nav-item"><a class="nav-link" href="{{ route('Photogallery.index') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Images</span>
                                </div>
                            </a><!-- more inner pages-->
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('Video.index') }}">
                    ...
                    <!-- parent pages-->
                    <a class="nav-link" href="{{ route('Projects.index') }}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                                ...
                                </svg><!-- <span class="fab fa-trello"></span> Font Awesome fontawesome.com --></span><span
                                class="nav-link-text ps-1">Projects</span></div>
                    </a>
                    <a class="nav-link" href="{{ route('Testimonials.index') }}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                                    class="svg-inline--fa fa-fire fa-w-12" aria-hidden="true" focusable="false"
                    ...
                    {{-- Start Careers --}}
                    <a class="nav-link" href="{{ route('careers.index') }}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                                    class="svg-inline--fa fa-fire fa-w-12" aria-hidden="true" focusable="false"
                                    data-prefix="fas" data-icon="fire" role="img"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                                ...
                                </svg></span><span class="nav-link-text ps-1">Careers</span></div>
                    </a>
                    {{-- End Careers --}}


                    {{-- Start Insta --}}
                    <a class="nav-link" href="{{ route('Instagram.index') }}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                                    class="svg-inline--fa fa-fire fa-w-12" aria-hidden="true" focusable="false"
                                    data-prefix="fas" data-icon="fire" role="img"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                                ...
                                </svg></span><span class="nav-link-text ps-1">Instagram</span></div>
                    </a>
                    {{-- End Insta --}}

                    <a class="nav-link" href="{{ route('Contact.index') }}" role="button">
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
