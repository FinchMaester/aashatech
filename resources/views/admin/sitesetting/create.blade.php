        ...
        <div class="card-body">
            <div>
                <div class="form-group">
                    ...
                    <input type="text" name="govn_name" class="form-control" placeholder="Government Name"
                        id="govn_name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="establishment">Established Year</label>
                    <input type="establishment" name="year" class="form-control" placeholder="Year" id="establishment">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="face_link" class="form-control" placeholder="Facebook URL (https://)"
                        id="face_link">
                </div>
                <div class="form-group">
                    <label for="insta_link">Insta URL</label>
                    <input type="url" name="insta_link" class="form-control" placeholder="Insta URL (https://)"
                        id="insta_link">
                </div>
                <div class="form-group">
                    <label for="linked_link">Linkedin URL</label>
                    <input type="url" name="linked_link" class="form-control" placeholder="LinkedIn URL (https://)"
                        id="linked_link">
                </div>
                <div class="form-group">
                    <label for="social_link">Social URL</label>
                    <input type="url" name="social_link" class="form-control" placeholder="Social URL (https://)"
                        id="social_link">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="f_page">Facebook Integration</label>
                    <input type="url" name="f_page" class="form-control" placeholder="Facebook page(https://)"
                        id="f_page">
                </div>

                <div class="form-group">
                    <label for="slogan">Slogan</label>
                    <textarea type="text" name="slogan" class="form-control" height="300" width="500"
                        placeholder="Your slogan Here" id="slogan">
                    </textarea>
                </div>
                <div class="form-group">
                    <label for="slogan">Description</label>
                    <textarea type="text" name="desc" class="form-control" height="300" width="500"
                        placeholder="Company Description here" id="desc">
                    </textarea>
                </div>
