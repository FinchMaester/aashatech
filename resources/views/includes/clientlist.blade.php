<section class="u-clearfix u-section-10" id="sec-3e08">
    <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-custom-color-1 u-text-default u-text-1">Our Clients</h2>
        <div
            class="u-expanded-width-lg u-expanded-width-xl u-gallery u-layout-horizontal u-lightbox u-no-transition u-show-text-on-hover u-gallery-1">
            <div class="u-gallery-inner">
                ...
                <div class="u-effect-fade u-gallery-item u-gallery-item-1">
                    ...
                    <div class="u-over-slide u-shading u-over-slide-1">
                        ...
                        <p class="u-gallery-text text-center">{{ $client->title}}</p>
                    </div>
                </div>
