   ...
   <!-- Content Wrapper. Contains page content -->
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
             ...
             <a href="{{ url('admin/legaldocs/create') }}"><button class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>Add Legal Documents</button></a> 
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            @foreach ($legaldocs as $legaldoc)
                <tr data-widget="expandable-table" aria-expanded="false">
                  <td width="5%">{{ $loop->iteration }}</td>
                    ...
                    <td > <img id="preview1"  src="{{ url('uploads/legaldocs/' . $legaldoc->image) }}"
