...
@section('content')
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            ...
            <a href="{{ route('Favicon.create') }}"><button class="btn-primary btn-sm"><i class="fa fa-plus"></i>
                    Add New</button></a>
        </div><!-- /.col -->
        <div class="col-sm-6">
            ...
            @foreach ($icons as $icon)
                <tr data-widget="expandable-table" aria-expanded="false">
                    ...
                    <td>
                        ...
                        <iframe src="{{ asset('uploads/favicon/file/' . $icon->file) }}" title=""
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="{{ url('admin/favicon/edit/' . $image->id) }}">
